...
![image](https://github.com/Kilamper/web-page/assets/73082382/f46f06a7-d996-4a07-bade-04a33bcb26fb)
...
| Criterios de validación                                                                                               | <p> 1. El menú principal debe ser visible en todas las páginas de la web.</p> <p> 2. La navegación debe ser intuitiva y fácil de entender para los usuarios.</p> <p>3. Cada sección del menú debe redirigir correctamente a la página correspondiente.</p> |
| Estimación                                                                                                            | 2 horas |
| Prioridad                                                                                                             | Alta |
...
| ----------------------------------------------------------------------------------------------------------------------| --- |
| Nombre                                                                                                                | Ver galería |
| Descripción                                                                                                           | Los usuarios deberán poder ver fotos y vídeos relacionados con la artesanía. |
| Criterios de validación                                                                                               | <p> 1. Los usuarios pueden navegar fácilmente entre las diferentes imágenes y vídeos.</p> <p> 2. Debe haber una sección separada para noticias relacionadas con la artesanía.</p> <p>3. La carga de las imágenes y vídeos debe ser rápida y eficiente.</p> |
| Estimación                                                                                                            | 5 horas |
| Prioridad                                                                                                             | Alta |
...
| Descripción                                                                                                           | Como usuario debería poder seleccionar un producto para observar información más detallada. |
| Criterios de validación                                                                                               | <p> 1. La información detallada debe incluir el nombre del producto, descripción, precio y opciones de compra.</p> <p> 2. Se deberá mostrar imágenes adicionales del producto, si están disponibles.</p> <p>3. Los usuarios pueden regresar fácilmente a la galería desde la página de detalle del producto.</p> |
| Estimación                                                                                                            | 5 horas |
| Prioridad                                                                                                             | Alta |
...
| Identificador                                                                                                         | HU05 |
| ----------------------------------------------------------------------------------------------------------------------| --- |
| Nombre                                                                                                                | Contactar artesano |
| Descripción                                                                                                           | Los usuarios deberán poder ponerse en contacto con los artesanos para poder solicitar información detallada o realizar consultas. |
| Criterios de validación                                                                                               | <p> 1. Debe haber un formulario de contacto o un botón de contacto visible para iniciar la interacción.</p> <p> 2. Los usuarios pueden enviar mensajes directos al artesano.</p> <p>3. Se debe proporcionar una opción para realizar pedidos personalizados directamente poniendose en contacto.</p> |
| Estimación                                                                                                            | 8 horas |
| Prioridad                                                                                                             | Alta |

| Identificador                                                                                                         | HU06 |
| ----------------------------------------------------------------------------------------------------------------------| --- |
| Nombre                                                                                                                | Buscar productos por categoría |
| Descripción                                                                                                           | Como usuario debería poder realizar una búsqueda para encontrar rápidamente lo que estoy buscando. |
| Criterios de validación                                                                                               | <p> 1. Debe haber una función de búsqueda por categoría en el catálogo.</p> <p> 2. Los usuarios pueden seleccionar una categoría y ver todos los productos asociados a ella.</p> <p>3. Debe haber opciones de filtrado adicionales para refinar la búsqueda, como por precio.</p> |
| Estimación                                                                                                            | 4 horas |
| Prioridad                                                                                                             | Alta |
...
| Descripción                                                                                                           | Los usuarios deben poder comprar productos directamente desde la página web. |
| Criterios de validación                                                                                               | <p> 1. Debe haber un proceso de compra claro y fácil de seguir.</p> <p> 2. Se debe proporcionar un formulario de pago seguro para completar la transacción.</p> <p>3. Los usuarios deben recibir confirmaciones de compra por correo electrónico.</p> |
| Estimación                                                                                                            | 9 horas |
| Prioridad                                                                                                             | Alta |

| Identificador                                                                                                         | HU08 |
| ----------------------------------------------------------------------------------------------------------------------| --- |
| Nombre                                                                                                                | Acceder a cursos |
| Descripción                                                                                                           | Los usuarios deben poder acceder a cursos relacionados con la artesanía desde la página web. |
| Criterios de validación                                                                                               | <p> 1. El menú principal debe ser visible en todas las páginas de la web.</p> <p> 2. La navegación debe ser intuitiva y fácil de entender para los usuarios.</p> <p>3. Cada sección del menú debe redirigir correctamente a la página correspondiente.</p> |
| Estimación                                                                                                            | 2 horas |
| Prioridad                                                                                                             | Alta |
...
| Identificador                                                                                                         | HU09 |
| ----------------------------------------------------------------------------------------------------------------------| --- |
| Nombre                                                                                                                | Acceso a vídeos |
| Descripción                                                                                                           | Los usuarios deben poder acceder a vídeos relacionados con la artesanía desde la página web. |
| Criterios de validación                                                                                               | <p> 1. Debe haber una sección dedicada a los vídeos en la página web.</p> <p> 2. Los usuarios pueden navegar y explorar los diferentes vídeos disponibles.</p> <p>3. Los usuarios pueden reproducir los vídeos directamente en la página web o en YouTube.</p> |
| Estimación                                                                                                            | 4 horas |
| Prioridad                                                                                                             | Media |
...
| Identificador                                                                                                         | HU10 |
| ----------------------------------------------------------------------------------------------------------------------| --- |
| Nombre                                                                                                                | Valorar y comentar |
| Descripción                                                                                                           | Los usuarios deben poder valorar y dejar comentarios sobre los productos y servicios ofrecidos en la página web. |
| Criterios de validación                                                                                               | <p> 1. Debe haber un sistema de valoración por estrellas para productos y cursos.</p> <p> 2. Los usuarios pueden dejar comentarios y reseñas sobre los productos, cursos y vídeos.</p> <p>3. Los usuarios pueden ver las valoraciones y comentarios dejados por otros usuarios.</p> |
| Estimación                                                                                                            | 6 horas |
| Prioridad                                                                                                             | Baja |

| Identificador                                                                                                         | HU11 |
| ----------------------------------------------------------------------------------------------------------------------| --- |
| Nombre                                                                                                                | Poner en favoritos |
| Descripción                                                                                                           | El usuario deberá poder destacar ciertos productos para acceder rápidamente a ellos en el futuro. |
| Criterios de validación                                                                                               | <p> 1. Debe haber un botón claro para agregar elementos a la lista de favoritos.</p> <p> 2. Los usuarios pueden ver y gestionar su lista de favoritos desde su perfil.</p> |
| Estimación                                                                                                            | 6 horas |
| Prioridad                                                                                                             | Baja |
...
| Descripción                                                                                                           | El usuario deberá poder agregar varias productos al carrito para realizar una compra conjunta. |
| Criterios de validación                                                                                               | <p> 1. Debe haber un botón claro para agregar productos al carrito.</p> <p> 2. Los usuarios pueden ver y gestionar los productos en su carrito.</p> |
| Estimación                                                                                                            | 8 horas |
| Prioridad                                                                                                             | Media |
